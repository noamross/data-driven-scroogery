...
which could actually result in an underestimate this year, too. Based on this model, views will grow ~49% every year and
 exceed thehuman population in another 12 years.

As an ecologist, t can thankfully point to a body of theory showing exponential
...
and see what wlast eekend's shopping experience tells us about what's to come.
...
We get almost the same result! Though maybe, just maybe, the flood
